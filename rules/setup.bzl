...
def bazel_common_setup(
    ...
    maven_install(
        ...
        artifacts = DAGGER_ARTIFACTS + [
            ...
            "com.android.tools.lint:lint-model:31.4.0-alpha09",
            "com.android.tools.external.com-intellij:intellij-core:31.4.0-alpha09",
            "com.android.tools.external.com-intellij:kotlin-compiler:31.4.0-alpha09",
            "com.android.tools.external.org-jetbrains:uast:31.4.0-alpha09",
            "com.android.tools.build:manifest-merger:31.4.0-alpha09",
            "com.android.tools:common:31.4.0-alpha09",
            "com.android.tools.layoutlib:layoutlib-api:31.4.0-alpha09",
            "com.android.tools:sdk-common:31.4.0-alpha09",
            "com.android.tools:sdklib:31.4.0-alpha09",
            ...
            "com.android.tools.build:builder-model:8.4.0-alpha09",
            "com.google.guava:guava:32.0.1-jre",
            "com.android.tools.lint:lint-checks:31.4.0-alpha09",
            "com.android.tools.analytics-library:protos:31.4.0-alpha09",
            "com.android.tools.analytics-library:shared:31.4.0-alpha09",
            "com.android.tools.analytics-library:tracker:31.4.0-alpha09",
            "com.android.tools.lint:lint:31.4.0-alpha09",
            "com.android.tools.lint:lint-api:31.4.0-alpha09",
        ],
        override_targets = {
            #            "com.android.tools.lint:lint-api": "@grab_bazel_common//patches:lint-api",
            #            "com.android.tools.lint:lint-cli": "@grab_bazel_common//patches:lint-cli",
            #            "com.android.tools.lint:lint": "@//patches:lint-cli",
        },
