...
def _android():
    ...
    http_archive(
        ...
        patches = [
            ...
            "@grab_bazel_common//patches/rules_android:connect_native_android_flags.patch",
            "@grab_bazel_common//patches/rules_android:native_databinding_package_info.patch",
            "@grab_bazel_common//patches/rules_android:package_aware_rtxt_tool.patch",
            "@grab_bazel_common//patches/rules_android:package_aware_rtxt_merge_action.patch",
            "@grab_bazel_common//patches/rules_android:busybox_package_aware_rtxt.patch",
            "@grab_bazel_common//patches/rules_android:provider_package_aware_rtxt.patch",
